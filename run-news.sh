...
# Notify Abah
curl -s -X POST http://localhost:3232/send -H "Content-Type: application/json" -d '{"text":"📰 Daily AI News published: nerdstudio.online/news/","to":"6281254571157"}' > /dev/null 2>&1
